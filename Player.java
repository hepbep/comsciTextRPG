...
class Player extends Character{
    ...
    public String[] atkUpgrades = {"Steel Blade", "Magicbane", "Sunblade", "Blade of the Ruined King"};
    public String[] defUpgrades = {"Leather Armour", "Thornmail", "Sunfire Aegis", "Shield of the Sol", "Crown of the Shattered Queen"};
